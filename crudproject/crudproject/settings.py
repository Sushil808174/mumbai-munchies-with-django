...
SECRET_KEY = 'django-insecure-r%u!pz48)kpopldq8a3krl06a&ml2ubewr!a=hkh3bp8lejel#'
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'crudapp','static'),  # Point to the folder containing 'static'
]
